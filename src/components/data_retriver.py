...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            numerical_columns = ["Year", "Month", "Day", "Hour", "Minute","EMASignal","isPivot", "Position","ordersignal","EMASignal1",
                                 "martiangle_signal",]

            categorical_columns = ["CHOCH_pattern_detected", 
                                 "fibonacci_signal", "SL", "TP", "MinSwing", 
                                 "MaxSwing", "LBD_detected", "LBH_detected", 
                                 "SR_signal", "isBreakOut", "candlestick_signal", 
                                 "result", "signal1", "buy_signal",  
                                 ...
                                 "TotSignal", "SLSignal", "grid_signal", 
                                  "SLSignal_heiken","long_signal","Candle_direction"]
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            history = model.fit(X_train, y_train, batch_size=256, epochs=400, validation_split=0.1)
